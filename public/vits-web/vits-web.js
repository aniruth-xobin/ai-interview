const u = "https://huggingface.co/diffusionstudio/piper-voices/resolve/main", B = "/onnxruntime-web/", x = "https://cdn.jsdelivr.net/npm/@diffusionstudio/piper-wasm@1.0.0/build/piper_phonemize", c = {
...
async function N(e, m) {
  h = h ?? await import("./piper-DeOu3H9E.js"), _ = _ ?? await import("/onnxruntime-web/esm/ort.min.js");
  ...
  }), r = 0, s = i.audio.sample_rate, d = i.inference.noise_scale, g = i.inference.length_scale, U = i.inference.noise_w, k = await f(`${u}/${n}`, m), y = (globalThis._onnxSessionCache = globalThis._onnxSessionCache || {}, globalThis._onnxSessionCache[n] = globalThis._onnxSessionCache[n] || await _.InferenceSession.create(await k.arrayBuffer())), w = {
